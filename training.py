...
train_loader = DataLoader(train_ds, batch_size=params.BATCH_SIZE, collate_fn=dataset.collate_batch, shuffle=True, num_workers=0)
print(f"DataLoader created.")
# Build the model
print(f"Net initialisation")
...
test_loader = DataLoader(test_ds, batch_size=params.BATCH_SIZE, shuffle=True, num_workers=0)  # , collate_fn=None, pin_memory=False)
